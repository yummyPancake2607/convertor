...
bool AudioExtractor::can_handle(const ConversionRequest& request,
...
Error AudioExtractor::convert(const ConversionRequest& request,
                               const MediaInfo& input_info,
                               ProgressCallback progress) {
    Logger::instance().info("AudioExtractor: " + request.input_extension() +
    ...
    // Extraction is a transcode of the audio track alone: the video stream is
